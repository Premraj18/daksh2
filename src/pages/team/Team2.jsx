    ...
    return (
        <Layout>
            <div className='h-full '>
                <div className="relative  bg-cover bg-fixed bg-center bg-no-repeat h-[80vh] "
                    style={{
                ...
                <div className='text-gray-50 bg-black  px-40 py-10 text-center'>
                ...
                <div className='text-gray-50 bg-black  px-40 py-10 text-center'>
                    <h3 className='text-center text-3xl'>WHO WE ARE</h3>
