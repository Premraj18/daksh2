        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-center w-full">
                    <p className="w-[80vw] text-lg text-center text-white font-semibold md:text-2xl my-12">"Dreams aspirations are not easily obtained but one of the hardest things to do is to keep going is to keep chasing.
