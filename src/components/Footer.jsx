        ...
        <footer className="body-font " style={{background: `linear-gradient(180deg,  rgba(15,182,0, 0.275) ,black , black)`}} >
            <div className="container px-5 pt-16 mx-auto" >
                ...
                <div className='lg:text-lg text-white flex '>
                    <p >Designed&Develop By: <a href="" className='text-lime-600'>Prem Raj</a> </p>
                </div>
            </div>
            ...
            {/* <div className="bg-gray-200"> */}
                <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <span className="inline-flex sm:ml-auto mr-20 sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a href='https://www.facebook.com/teamdaksh.nitjsr/' target='_blank' className="text-gray-50 hover:text-lime-600 cursor-pointer">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                            </svg>
                        </a>
                        
                        <a href="https://www.instagram.com/team.daksh/" target='_blank' className="ml-3 text-gray-50 hover:text-lime-600 cursor-pointer">
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
                                <rect width={20} height={20} x={2} y={2} rx={5} ry={5} />
                                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01" />
                            </svg>
                        </a>
                        <a href='https://in.linkedin.com/company/teamdaksh' target='_blank' className="ml-3 text-gray-50 hover:text-lime-600 cursor-pointer">
